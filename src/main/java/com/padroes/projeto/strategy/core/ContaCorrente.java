...
@Component
public class ContaCorrente implements AcoesConta {

    @Autowired
    private ContaRepository contaRepository;

    @Override
    public void criarConta(final Conta conta) {
        Random random = new Random();
        conta.setSaldoInicial(5000.00);
        conta.setAgencia("C-".concat(String.valueOf(random.nextInt(20))));
